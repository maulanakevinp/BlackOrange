...
@section('title', App\Utility::find(1)->nama_website . ' - Kelola Brand')
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route("brand.store") }}" class="dropzone dz-clickable" id="dropzoneForm" method="POST">
                    @csrf
