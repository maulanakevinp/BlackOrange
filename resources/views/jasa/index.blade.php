...
@section('title', App\Utility::find(1)->nama_website . ' - Jasa & Layanan')
    ...
    <div class="container">
        <form class="mb-5" action="{{ URL::current() }}" method="GET">
            <div class="input-group mb-3">
                <input type="text" class="form-control" name="cari" value="{{ request('cari') }}" placeholder="Cari jasa & layanan disini ...">
                ...
                <div class="col-lg-4 col-md-6 col-sm-10 mb-200 mt-50">
                    <div class="single-services">
                        ...
                        <div class="services-caption">
                            <h3>
                                @if (count($product->images) > 0)
                                    <a href="{{ route("jasa.show", ['produk' => $product, 'slug' => Str::slug($product->nama_produk)]) }}" title="Detail Jasa & Layanan">{{ $product->nama_produk }}</a>
                                @else
                                    <a href="#" title="Detail Jasa & Layanan Tidak Tersedia Karena Tidak Ada Gambar">{{ $product->nama_produk }}</a>
                                @endif
                            </h3>
                            ...
                            @auth
                                <div class="float-right mt-4">
                                    <button data-link="{{ route('jasa.edit', $product) }}" class="mx-1 bg-success p-2 rounded border-0 edit" title="Edit Jasa & Layanan">
