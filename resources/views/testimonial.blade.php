...
@section('title', App\Utility::find(1)->nama_website . ' - Testimoni')
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route("testimonial.store") }}" class="dropzone dz-clickable" id="dropzoneForm" method="POST">
                    @csrf
...
<script>
    ...
    function load_more(page) {
        $.ajax({
            url: "/load-testimonial?page="+page,
            method: "GET",
            beforeSend: function () {
                $("#loading").show();
            },
